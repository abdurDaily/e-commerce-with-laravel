            ...
            <div class="wrapper-control-shop gridLayout-wrapper">
                    ...
                    <div class="card-product style-list" data-availability="In stock" data-brand="Vineta">
                        <div class="card-product-wrapper">
                            <a href="product-detail.html" class="product-img">
                                <img class="img-product lazyload" data-src="{{ $product->product_img }}" src="{{ $product->product_img }}" alt="image-product">
                                <img class="img-hover lazyload" data-src="{{ $product->product_img }}" src="{{ $product->product_img }}" alt="image-product">
                            </a>
                ...
                <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                    ...
                    <div class="card-product grid style-1 card-product-size" data-availability="In stock" data-brand="Vineta">
                        <div class="card-product-wrapper">
                            <a href="product-detail.html" class="product-img">
                                <img class="img-product ls-is-cached lazyloaded" data-src="{{ $product->product_img }}" src="{{ $product->product_img }}" alt="image-product">
                                <img class="img-hover ls-is-cached lazyloaded" data-src="{{ $product->product_img }}" src="{{ $product->product_img }}" alt="image-product">
                            </a>
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="name-product link fw-medium text-md">{{ $product->product_title }}</a>
